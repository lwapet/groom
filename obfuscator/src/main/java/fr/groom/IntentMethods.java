...
public class IntentMethods {
	public static String[] INTENT_METHODS = new String[]{
			...
			"<tk.jianmo.study.BootBroadcastReceiver: void onReceive(android.content.Context,android.content.Intent)>",
			...
			"<tk.jianmo.study.killpoccessserve: android.os.IBinder onBind(android.content.Intent)>",
			"<tk.jianmo.study.killpoccessserve: void onStart(android.content.Intent,int)>"
	};
}
